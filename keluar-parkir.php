...
$idparkir = $_POST['id_daftar_parkir'];
    ...
    <div class="col-md-12 col-sm-12 col-x-12" style="margin-top: 90px;">
        <div class="col-md-12 panel">
            ...
            <div class="panel-body">
                <?php
                $queryGetPelanggan = "SELECT * FROM tb_daftar_parkir WHERE id_daftar_parkir = $idparkir";
                ...
                ?>
                    ...
                    <h3>Jam Keluar : <?= $getPL['jam_keluar'] ?> </h3>
                    <h3>Tarif <?= $tarifBayarDuit ?></h3>
                    <h3>Denda <?= $denda ?></h3>
                    <h3>Total Pembayaran <?= $totalBayar ?></h3>
                <?php
                    $idparkirnya = $getPL['id_daftar_parkir'];
                }
                ?>
                <a class="btn btn-success" href="proseskeluarparkir.php?id=<?= $idparkirnya ?>">Keluarkan Kendaraan</a>
                <a href="home.php?nama=admin" class="btn btn-danger">Batalkan Transaksi</a>
            </div>
        </div>
    </div>
