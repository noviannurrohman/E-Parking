...
include 'config/koneksi.php';
	...
	$query = mysqli_query($con, "SELECT kode,plat_nomor FROM tb_daftar_parkir_biasa WHERE plat_nomor='$_GET[plat_nomor]'");
	$data = mysqli_fetch_array($query);

	if (isset($_POST['btn_print'])) {
		echo "<script>document.location.href='home_biasa.php?nama=$username'</script>";
	}
 ?>
