  ...
  <div id="content">
    ...
    <div class="col-md-7" style="margin-top: 30px;">
      <div class="col-md-10 panel">
        <div class="col-md-12 panel-heading bg-teal">
          <h4 style="color: white;font-size: 20pt;">Masuk Parkir VIP<span class="right" style="color : #f6c700; font-weight: bold; text-align: right; padding-right: 10px;">Empty : <?= $cek_kosong ?></span></h4>
        </div>
    ...
    <div class="col-md-5" style="margin-top: 30px">
      <div class="col-md-10 panel">
        ...
        <div class="col-md-12 panel-body" style="padding-bottom:25px;">
          <div class="col-md-12">
            <form class="cmxform" action="keluar-parkir.php" method="POST">
              <div class="col-md-12">
                <div class="form-group form-animate-text" style="margin-top:25px !important;">
                  <span class="bar"></span>
                  <?php
                  $queryGetAllParkir = "SELECT * FROM tb_daftar_parkir WHERE status = 'ada'";
                  $executeGetAllParkir = mysqli_query($con, $queryGetAllParkir);
                  ?>
                  <select name="id_daftar_parkir">
                    <?php
                    while ($keluarr = mysqli_fetch_array($executeGetAllParkir)) {
                    ?>
                      <option value="<?= $keluarr['id_daftar_parkir'] ?>">Tempat Parkir <?= $keluarr['id_daftar_parkir'] ?> - <?= $keluarr['plat_nomor'] ?> - <?= $keluarr['jenis'] ?> <?= $keluarr['merk'] ?></option>
                    <?php
                    }
                    ?>
                  </select>
          ...
          <table class="table table-hover col-md-12 col-sm-12 col-xs-12" width="100%" cellspacing="0">
            <thead>
              <tr style="font-size: 13pt">
                <th style="max-width: 120px;">Tempat Parkir Nomor</th>
                <th>Kode</th>
