          ...
          <div class="col-md-12 panel-body" style="padding-bottom:400px;">
                        <div class="col-md-11">
                          <form class="cmxform" method="POST">
                              ...
                              <form class="cmxform" method="POST">
                              <input class="submit btn btn-primary col-md-5 col-sm-5 col-xs-12" style="margin-top: 10px; margin-left: 100px; height: 40px;" type="submit" value="Member" name="loginmember">
                              </form>
                        </div>                       
          </div>
