...
<?php
  ...
  $cek_isi = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir_biasa"));

  $cek_mobil = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir_biasa WHERE jenis ='Mobil'"));
  $cek_motor = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir_biasa WHERE jenis ='Motor'"));
  $cek_lainnya = mysqli_num_rows(mysqli_query($con, "SELECT * FROM tb_daftar_parkir_biasa WHERE jenis ='Truk/Bus/Lainnya'"));
 ?>
...
<body class="dashboard topnav">
  <!-- start: Header -->
        <nav class="navbar navbar-default header navbar-fixed-top bg-teal">
          ...
          <li><a href="home.php?nama=<?= $username ?>"style="font-size: 18pt">Parkir VIP</a></li>
          <li><a href="home_biasa.php?nama=<?= $username ?>" style="font-size: 18pt">Parkir Biasa</a></li>
          <li class="active"><a href="daftar_kendaraan.php?nama=<?= $username ?>"><span style="font-size: 18pt">Daftar Kendaraan</a></span></li>
        </ul>
               ...
               <!-- History Kendaraan -->          
                <div class="col-md-6 col-sm-12 col-xs-12"  style="margin-top: 10px;">
                  <div class="col-md-12 panel">
                    ...
                    <tbody>
                      <?php 
                        $sql = "SELECT * FROM tb_daftar_parkir_biasa WHERE status = '2'";
                        $query = mysqli_query($con, $sql);
